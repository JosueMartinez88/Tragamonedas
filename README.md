...
3. Vas a descargarlo todo en .zip y (desde la parte principal, donde dice com/app) lo vas a implementar en tu proyecto que quieras ocuparlo pegando todo a las clases junto con paquetes
